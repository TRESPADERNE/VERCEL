...
const VERSION_POLL_MS = 45 * 1000; // Reducimos un poco el tiempo de espera del navegador
...
const VERSION_CACHE_CONTROL = "public, max-age=5, s-maxage=15"; // La versión caduca muy rápido en la CDN
